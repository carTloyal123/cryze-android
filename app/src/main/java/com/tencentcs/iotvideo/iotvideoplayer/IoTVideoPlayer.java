...
//                LogUtils.i(IoTVideoPlayer.TAG, "nativeIAudioRender onFrameUpdate");
    ...
    public boolean startRecord(String str, String str2, boolean z10, IRecordListener iRecordListener) {
        ...
        if (IoTVideoSdk.isSupportedCurrentAbi()) {
            if (!isPlaying()) {
                LogUtils.i(TAG, "player is not connected, player state:" + getPlayState());
            ...
            if (z10 && this.isSupportEncode) {
                ...
                mediaCodecVideoEncoder.setCheckCodecListener(new IMediaCodecCheckListener() { // from class: com.tencentcs.iotvideo.iotvideoplayer.IoTVideoPlayer.13
                    ...
                    public void onCodecCheckFail(int i) {
            ...
            return nativeStartRecord(str4, new IRecordListener() { // from class: com.tencentcs.iotvideo.iotvideoplayer.IoTVideoPlayer.14
                ...
                public void onPositionUpdated(final long j, final long j2) {
                    if (IoTVideoPlayer.this.isMainThread()) {
                        iRecordListener.onPositionUpdated(j, j2);
                    } else {
                ...
                @Override // com.tencentcs.iotvideo.iotvideoplayer.IRecordListener
                public void onResult(final int i, final String str5) {
                    if (IoTVideoPlayer.this.isMainThread()) {
                        if (!IoTVideoPlayer.this.isRecordFail) {
                            iRecordListener.onResult(i, str5);
                            return;
                        } else {
